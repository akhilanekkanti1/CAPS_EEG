...
[throwAway, badChannels1] = pop_rejchan(EEG, 'elec' ,[1:64] , 'threshold' ,3, 'norm' , 'on' , 'measure' , 'kurt'); %#ok<NBRAK>
[throwAway, badChannels2] = pop_rejchan(EEG, 'elec',[1:64] ,'threshold',2,'norm','on','measure','spec','freqrange',[1 125] );
[throwAway, badChannels3] = pop_rejchan(EEG, 'elec',[1:64] ,'threshold',2,'norm','on','measure','prob' );
badChannels = [badChannels1 badChannels2 badChannels3];
% spherical interpolation of bad channels
EEG = pop_interp(EEG, badChannels, 'spherical' );
